...
$url        = 'https://reshade.me/downloads/ReShade_Setup_3.0.8.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'reshade*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
