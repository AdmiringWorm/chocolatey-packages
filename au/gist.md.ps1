$(
    ...
    $GitHubUserRepo = $options.RepoName;
    $AppveyorProjectId = $options.AppveyorProjectId;
    $BuildNumber = $options.BuildNumber;
    If ($BuildNumber) {
        $BuildPath = "/build/$BuildNumber";
    } Else {
        $BuildPath = "";
    }
    $Branch = $options.GitBranch;
    If ($AppveyorProjectId) {
        "[![](https://ci.appveyor.com/api/projects/status/$($AppveyorProjectId)?svg=true)](https://ci.appveyor.com/project/$GitHubUserRepo$BuildPath)"
    }
)
...
_This file is automatically generated by the [update_all.ps1](https://github.com/$GitHubUserRepo/blob/$Branch/au/update_all.ps1) script using the [AU module](https://github.com/majkinetor/au) ( [view source](https://github.com/$GitHubUserRepo/blob/$Branch/au/gist.md.ps1) )._
